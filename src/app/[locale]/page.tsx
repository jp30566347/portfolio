  ...
  return (
    <div className="mt-8 flex flex-col sm:flex-row gap-12 items-center sm:items-start">
      <div className="flex flex-col gap-5 px-4 sm:px-0">
        ...
        <p>
          I thrive at the{" "}
          <mark>crossroads of Product, UX, and Engineering</mark>, always
        ...
        <p>
          ...
          often rely on the robustness of <mark>Postgres</mark> through various
          languages like <mark>TypeScript</mark>, <mark>Rails</mark> or{" "}
          <mark>Go</mark>. I also have a strong interest in learning{" "}
          <mark>Rust</mark>.
        </p>
        <p>
